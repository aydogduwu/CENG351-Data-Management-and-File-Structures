...
public class Evaluation {
    ...
    private static String user = "e1234567"; // Your userName
    private static String password = "password"; // Your password
    private static String host = "144.122.71.57"; // host name
    private static String database = "db1234567"; // Your database name
    ...
    public static void main(String[] args) {
       ...
       /***********************************************************/
       // While running on your local machine, change musicdbDirectory accordingly
